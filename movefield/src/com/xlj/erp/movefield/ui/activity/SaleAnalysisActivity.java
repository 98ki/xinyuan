...
public class SaleAnalysisActivity extends BaseToolbarActivity {
	...
	public int getLayoutResId() {
		return R.layout.activity_sale_analysis_1;
	}
	...
	public void findViews() {
		tv_time_label = (TextView) this.findViewById(R.id.tv_time_label);
		img_selecttime = (ImageView) this.findViewById(R.id.img_selecttime);
		tv_selecttime = (TextView) this.findViewById(R.id.tv_selecttime);
		
		tv_rate = (TextView) this.findViewById(R.id.tv_rate);
		
		tv_signamount = (TextView) this.findViewById(R.id.tv_signamount);
		tv_targetamount = (TextView) this.findViewById(R.id.tv_targetamount);
		
		tv_signcount = (TextView) this.findViewById(R.id.tv_signcount);
		tv_signarea = (TextView) this.findViewById(R.id.tv_signarea);
		
		tv_subscribeamount = (TextView) this.findViewById(R.id.tv_subscribeamount);
		tv_subscribearea = (TextView) this.findViewById(R.id.tv_subscribearea);
		tv_subscribecount = (TextView) this.findViewById(R.id.tv_subscribecount);
		
		day_roseChart = (RoseChart01View) this.findViewById(R.id.day_roseChart);
		week_roseChart = (RoseChart01View) this.findViewById(R.id.week_roseChart);
		month_roseChart = (RoseChart01View) this.findViewById(R.id.month_roseChart);
		quarter_roseChart = (RoseChart01View) this.findViewById(R.id.quarter_roseChart);
		year_roseChart = (RoseChart01View) this.findViewById(R.id.year_roseChart);
	...
	public void onClick(View v) {
		...
		switch(v.getId()){
			...
			case R.id.relative_day:
	        	...
	        	img_quarter.setVisibility(View.GONE);
	        	img_year.setVisibility(View.GONE);*/
				popupWindow.dismiss();
				break;
			...
			case R.id.relative_quarter:
				...
				/*popSelectIndex = 3;
				img_quarter.setVisibility(View.VISIBLE);
				img_month.setVisibility(View.GONE);
	        	img_day.setVisibility(View.GONE);
	        	img_week.setVisibility(View.GONE);
	        	img_year.setVisibility(View.GONE);
	...
	private void showPopWindow(){
		...
		/*if(popSelectIndex == 0){
        	...
        	img_quarter.setVisibility(View.GONE);
        	img_year.setVisibility(View.GONE);
        }else if(popSelectIndex == 3){
        	img_quarter.setVisibility(View.VISIBLE);
        	img_month.setVisibility(View.GONE);
        	img_day.setVisibility(View.GONE);
        	img_week.setVisibility(View.GONE);
        	img_year.setVisibility(View.GONE);
        }else if(popSelectIndex == 4){
        	img_year.setVisibility(View.VISIBLE);
        	img_month.setVisibility(View.GONE);
        	img_day.setVisibility(View.GONE);
        	img_week.setVisibility(View.GONE);
		...
		switch(popSelectIndex){
			case 0:
				...
				if(monitorSaleAnalysis.day != null){
					tv_time_label.setText("当日销售分析");
					tv_rate.setText(Integer.parseInt(monitorSaleAnalysis.day.signamount)/Integer.parseInt(monitorSaleAnalysis.day.targetamount)*100 + "%");
					tv_signamount.setText(monitorSaleAnalysis.day.signamount+"万元");
					tv_targetamount.setText(monitorSaleAnalysis.day.targetamount+"万元");
					tv_signcount.setText(monitorSaleAnalysis.day.signcount+"套");
					tv_signarea.setText(monitorSaleAnalysis.day.signarea+"M2");
			...
			case 1:
				...
				if(monitorSaleAnalysis.week != null){
					...
					tv_rate.setText(Integer.parseInt(monitorSaleAnalysis.week.signamount)/Integer.parseInt(monitorSaleAnalysis.week.targetamount)*100 + "%");
			...
			case 2:
				...
				if(monitorSaleAnalysis.month != null){
					...
					tv_rate.setText(Integer.parseInt(monitorSaleAnalysis.month.signamount)/Integer.parseInt(monitorSaleAnalysis.month.targetamount)*100 + "%");
			...
			case 3:
				...
				if(monitorSaleAnalysis.quarter != null){
					...
					tv_rate.setText(Integer.parseInt(monitorSaleAnalysis.quarter.signamount)/Integer.parseInt(monitorSaleAnalysis.quarter.targetamount)*100 + "%");
			...
			case 4:
				...
				if(monitorSaleAnalysis.year != null){
					...
					tv_rate.setText(Integer.parseInt(monitorSaleAnalysis.year.signamount)/Integer.parseInt(monitorSaleAnalysis.year.targetamount)*100 + "%");
