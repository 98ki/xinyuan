...
public class SplineChart01View extends TouchView {
	...
	public void chartRender(LinkedList<String> labels,LinkedList<SplineData> chartData,int max,int step)
	{
		try {
			...
			int [] ltrb = new int[4];
			ltrb[0] = DensityUtil.dip2px(getContext(), 20); //top	
