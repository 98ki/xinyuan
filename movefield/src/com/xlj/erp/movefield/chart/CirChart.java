...
public class CirChart extends XChart{
	...
	protected float mOffsetAgent = 270f;//180;
	...
	protected void calcPlotRange()
	{
		...
		this.mRadius = Math.min( this.plotArea.getWidth() , this.plotArea.getHeight() );
	}
			...
			final Paint paint)
	{
		...
		{			 
		    ...
		    //标签
		    //canvas.drawText(text,endX, stopY,mPaintLabel);   
		    canvas.drawText(text,endX, stopY,paint);   
